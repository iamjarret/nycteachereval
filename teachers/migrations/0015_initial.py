...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teachers_distribution', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('values', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=10, null=True, blank=True)),
            ('dist', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=10, null=True, blank=True)),
            ('total', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('teachers', ['Distribution'])
        ...
        db.create_table('teachers_district', (
            ...
            ('classsize_dist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teachers.Distribution'], to_field='name')),
            ('avgclasssize', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('teachers_distribution')
    ...
    models = {
        'teachers.borough': {
            ...
            'classsize_dist': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teachers.Distribution']", 'to_field': "'name'"}),
